...
class SSL_GeometryFieldSize : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SSL_GeometryFieldSize) */ {
 ...
 private:
  ...
  void set_has_test_num();
  void clear_has_test_num();
...
inline ::google::protobuf::int32 SSL_GeometryFieldSize::test_num() const {
  // @@protoc_insertion_point(field_get:SSL_GeometryFieldSize.test_num)
  return test_num_;
}
inline void SSL_GeometryFieldSize::set_test_num(::google::protobuf::int32 value) {
  set_has_test_num();
  test_num_ = value;
  // @@protoc_insertion_point(field_set:SSL_GeometryFieldSize.test_num)
}
