...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 20, sizeof(::SSL_GeometryFieldSize)},
  { 35, 55, sizeof(::SSL_GeometryCameraCalibration)},
  { 70, 77, sizeof(::SSL_GeometryData)},
};
...
SSL_GeometryFieldSize::SSL_GeometryFieldSize(const SSL_GeometryFieldSize& from)
  ...
  ::memcpy(&line_width_, &from.line_width_,
    static_cast<size_t>(reinterpret_cast<char*>(&test_num_) -
    reinterpret_cast<char*>(&line_width_)) + sizeof(test_num_));
...
void SSL_GeometryFieldSize::SharedCtor() {
  ::memset(&line_width_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&test_num_) -
      reinterpret_cast<char*>(&line_width_)) + sizeof(test_num_));
}
...
// @@protoc_insertion_point(message_clear_start:SSL_GeometryFieldSize)
  ...
  if (cached_has_bits & 32512u) {
    ::memset(&center_circle_radius_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&test_num_) -
        reinterpret_cast<char*>(&center_circle_radius_)) + sizeof(test_num_));
  }
  _has_bits_.Clear();
