...
class grSim_Packet : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:grSim_Packet) */ {
 public:
  ...
  private:
  const ::sslDebug_Data& _internal_debuginfo() const;
  public:
...
inline const ::sslDebug_Data& grSim_Packet::_internal_debuginfo() const {
  return *debuginfo_;
}
inline const ::sslDebug_Data& grSim_Packet::debuginfo() const {
  const ::sslDebug_Data* p = debuginfo_;
  // @@protoc_insertion_point(field_get:grSim_Packet.debuginfo)
  return p != NULL ? *p : *reinterpret_cast<const ::sslDebug_Data*>(
...
inline ::sslDebug_Data* grSim_Packet::mutable_debuginfo() {
  set_has_debuginfo();
  if (debuginfo_ == NULL) {
    auto* p = CreateMaybeMessage<::sslDebug_Data>(GetArenaNoVirtual());
    debuginfo_ = p;
  }
...
inline void grSim_Packet::set_allocated_debuginfo(::sslDebug_Data* debuginfo) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(debuginfo_);
  }
  if (debuginfo) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      debuginfo = ::google::protobuf::internal::GetOwnedMessage(
