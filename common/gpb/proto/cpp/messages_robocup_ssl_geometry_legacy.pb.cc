...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_messages_5frobocup_5fssl_5fgeometry_5flegacy_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_SSL_GeometryFieldSize;
}  // namespace protobuf_messages_5frobocup_5fssl_5fgeometry_5flegacy_2eproto
...
::google::protobuf::internal::SCCInfo<2> scc_info_SSL_GeometryData =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsSSL_GeometryData}, {
      &protobuf_messages_5frobocup_5fssl_5fgeometry_5flegacy_2eproto::scc_info_SSL_GeometryFieldSize.base,
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "messages_robocup_ssl_geometry_legacy.proto", schemas, file_default_instances, TableStruct::offsets,
...
const SSL_GeometryFieldSize& SSL_GeometryFieldSize::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_messages_5frobocup_5fssl_5fgeometry_5flegacy_2eproto::scc_info_SSL_GeometryFieldSize.base);
...
SSL_GeometryData::SSL_GeometryData()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_messages_5frobocup_5fssl_5fgeometry_5flegacy_2eproto::scc_info_SSL_GeometryData.base);
  SharedCtor();
...
const SSL_GeometryData& SSL_GeometryData::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_messages_5frobocup_5fssl_5fgeometry_5flegacy_2eproto::scc_info_SSL_GeometryData.base);
  return *internal_default_instance();
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::RoboCup2014Legacy::Geometry::SSL_GeometryFieldSize* Arena::CreateMaybeMessage< ::RoboCup2014Legacy::Geometry::SSL_GeometryFieldSize >(Arena* arena) {
  return Arena::CreateInternal< ::RoboCup2014Legacy::Geometry::SSL_GeometryFieldSize >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::RoboCup2014Legacy::Geometry::SSL_GeometryData* Arena::CreateMaybeMessage< ::RoboCup2014Legacy::Geometry::SSL_GeometryData >(Arena* arena) {
